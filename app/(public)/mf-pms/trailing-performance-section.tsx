  ...
  return (
    <section className="p-20">
      <div className="flex flex-col justify-around gap-8">
        <div>
          <h1 className="font-semibold text-6xl">Trailing 12 M Performance</h1>
        ...
        <p className="text-xl  text-[#C2C2C2]">
        ...
        <div className="bg-[#151515] p-8 w-full text-xl flex flex-col rounded-md">
          <h3>For Example.,</h3>
