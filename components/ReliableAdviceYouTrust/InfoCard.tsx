...
export const InfoCard: React.FC<InfoCardProps> = ({ title, description }) => {
  return (
    <article className="grow text-white max-md:mt-5 max-md:max-w-full">
      <div className="flex flex-col px-7 pt-6 pb-9 rounded-3xl bg-zinc-900 bg-opacity-70 max-md:px-5 max-md:max-w-full">
