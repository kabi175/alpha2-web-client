...
export const PMSCardHeader: React.FC<PMSCardHeaderProps> = ({ title }) => {
  return (
    <header className="rounded-t-3xl self-stretch border border-solid bg-neutral-800 bg-opacity-70 border-zinc-800">
      <div className="rounded-t-3xl flex flex-col justify-center px-px py-6 w-full border border-solid bg-neutral-700 bg-opacity-10 border-neutral-700 border-opacity-40">
